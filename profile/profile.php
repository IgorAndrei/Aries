                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                        	<div id="usuario_bievenida"> Bienvenido  <?php echo $login_session; ?>&nbsp;<?php echo $login_session1; ?> </div>
                            Herramientas <!--<small>Competencias Genericas</small>-->
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    ...
                                    <a href="#" class="list-group-item">
                                        <span class="badge"><?php echo $login_session2; ?></span>
                                        <i class="fa fa-fw fa-globe"></i> Ultimo Acceso
                                    </a>
                                </div>
