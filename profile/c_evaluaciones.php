        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="profile.php"><i class="fa fa-dashboard"></i> Panel Control</a>
                    </li>
                    <li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Subir o crear  <small>Material.</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            <label>campo de texto con holder</label>
                                            <input class="form-control" placeholder="lala">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Radio Buttons linea</label>
                                        ...
                                        <div class="form-group">
                                            <label>seleccion multiple</label>
                                ...
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <h4>Disabled estados</h4>
                                    <form role="form">
                                        <fieldset disabled>
                                            <div class="form-group">
                                                <label for="disabledSelect">desactivado input</label>
                                                <input class="form-control" id="disabledInput" type="text" placeholder="lalala" disabled="">
                                            </div>
                                            <div class="form-group">
                                                <label for="disabledSelect">desactivado  menu</label>
                                                <select id="disabledSelect" class="form-control">
                                                    <option>desactivado select</option>
                                                </select>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox">desactivado Checkbox
                                                </label>
                                            </div>
                                            <button type="submit" class="btn btn-primary">desactivado Button</button>
                                        </fieldset>
                                    </form>
                                    <h4>Estados</h4>
                                    <form role="form">
                                        <div class="form-group has-success">
                                            <label class="control-label" for="inputSuccess">aprobado</label>
                                            <input type="text" class="form-control" id="inputSuccess">
                                        </div>
                                        <div class="form-group has-warning">
                                            <label class="control-label" for="inputWarning">alerta</label>
