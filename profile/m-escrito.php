    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                       <a href="audio-visual.php"><i class="fa fa-video-camera"></i> Material AudiVisual</a>
                    </li>
                     <li>
                       <a class="active-menu" href="m-escrito.php"><i class="fa fa-edit"></i> Material Escrito</a>
                    </li>                    
                    <li>
        ...
        <div id="page-wrapper" >
                        ...
                        <div class="panel-body">
                            <div class="panel-group" id="accordion">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="collapsed">Grupo#1</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Grupo #2</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree" class="collapsed">Grupo#3</a>
                                        </h4>
                                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                ...
                                <li class=""><a href="#profile" data-toggle="tab">Perfil</a>
                                </li>
                                <li class=""><a href="#messages" data-toggle="tab">Mensaje</a>
                                </li>
                                <li class=""><a href="#settings" data-toggle="tab">Configuración</a>
                                </li>
                            </ul>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills">
                                ...
                                <li class=""><a href="#profile-pills" data-toggle="tab">Perfil</a>
                                </li>
                                <li class=""><a href="#messages-pills" data-toggle="tab">Mensajes</a>
                                </li>
                                <li class="active"><a href="#settings-pills" data-toggle="tab">Configuración</a>
                                </li>
                            </ul>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <div class="well">
                        <h4>Espaciado Normal</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tincidunt est vitae ultrices accumsan. Aliquam ornare lacus adipiscing, posuere lectus et, fringilla augue.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4">
                    <div class="well well-lg">
                        <h4>Espaciado Largo</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tincidunt est vitae ultrices accumsan. Aliquam ornare lacus adipiscing, posuere lectus et, fringilla augue.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4">
                    <div class="well well-sm">
                        <h4>Espaciado Pequeño</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tincidunt est vitae ultrices accumsan. Aliquam ornare lacus adipiscing, posuere lectus et, fringilla augue.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="jumbotron">
                        ...
                        <p>
                            <a class="btn btn-primary btn-lg" role="button">Leer Más</a>
                        </p>
                    </div>
                </div>
            </div>
